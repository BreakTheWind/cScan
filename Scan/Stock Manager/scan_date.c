...
{
	return ((digit_get64((uint32_t)date, 1) * 10) + (digit_get64((uint32_t)date, 0) * 1));
}

int date_month(uint32_t date)
{
	return ((digit_get64((uint32_t)date, 3) * 10) + (digit_get64((uint32_t)date, 2) * 1));
}

int date_year(uint32_t date)
{
	return ((digit_get64((uint32_t)date, 7) * 1000) + (digit_get64((uint32_t)date, 6) * 100) + (digit_get64((uint32_t)date, 5) * 10) + (digit_get64((uint32_t)date, 4) * 1));
}
